...
const ReadGame = () => {
    ...
    const audio = useRef()
    const quizQuestion = useSelector((state) => state.listening.quizQuestion)
    ...
    const endGame = () => {
        ...
        dispatch(listeningActions.postDataQuizzRead({listQuiz :params }))
        ...
        <Row>
            ...
            <WrapNewGame>
                <audio controls autoPlay ref={audio} style={{display: 'none'}}>
                    <source src={quizQuestion[questionIndex].audio.url} type="audio/ogg" />
                </audio>
