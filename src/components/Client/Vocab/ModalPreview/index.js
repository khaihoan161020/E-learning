...
const ModalPreview = ({}) => {
  ...
  const visibleModal = useSelector((state) => state.read.visibleModalPreview);
  const item = useSelector((state) => state.read.quizPreviewItem);
  ...
  return (
    ...
    >
      <Form {...layout} form={form} name="control-hooks">
        ...
        <FooterModal>
          <Button onClick={() => dispatch(readActions.toggleModalPreview())}>
